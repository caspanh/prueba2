...
return array(
    ...
    'Do you really want to remove this user: "%s"?' => '¿Desea eliminar a este usuario: « %s » ?',
    ...
    'Do you really want to remove this project: "%s"?' => '¿Desea eliminar este proyecto: « %s » ?',
    ...
    'Do you really want to remove this column: "%s"?' => '¿Desea eliminar esta columna : « %s » ?',
    ...
    'Application settings' => 'Configuracion de la aplicación',
    'Language' => 'Idioma',
    ...
    'Do you really want to open this task: "%s"?' => '¿Desea abrir esta tarea: « %s » ?',
    ...
    'Sorry, I didn\'t find this information in my database!' => '¡Lo siento no he encontrado esta información!',
    ...
    'Do you really want to remove this task: "%s"?' => '¿Desea eliminar esta tarea: "%s"?',
    ...
    'Do you really want to remove this category: "%s"?' => '¿Desea eliminar esta categoría: "%s"?',
    ...
    'Do you really want to remove this file: "%s"?' => '¿Desea borrar este fichero: "%s"?',
    ...
    'Estimate:' => 'Estimado:',
    'Spent:' => 'Transcurrido:',
    'Do you really want to remove this sub-task?' => '¿Desea eliminar esta sub-tarea?',
    'Remaining:' => 'Restante:',
    'hours' => 'horas',
    'spent' => 'transcurrido',
    'estimated' => 'estimado',
    ...
    'I want to receive notifications only for those projects:' => 'Quiero recibir notificaciones de estos proyectos:',
    ...
    'Do you really want to disable this project: "%s"?' => '¿Desea desactivar este proyecto: "%s"?',
    'Do you really want to enable this project: "%s"?' => '¿Desea activar este proyecto: "%s"?',
    ...
    'Do you really want to duplicate this task?' => '¿Desea duplicar esta tarea?',
    ...
    'Write' => 'Grabar',
    'Active swimlanes' => 'Canales activos',
    'Add a new swimlane' => 'Añadir nuevo canal',
    'Change default swimlane' => 'Cambiar el canal por defecto',
    'Default swimlane' => 'Canal por defecto',
    'Do you really want to remove this swimlane: "%s"?' => '¿Desea quitar este canal: "%s"?',
    'Inactive swimlanes' => 'Calnal inactivo',
    'Remove a swimlane' => 'Quitar un canal',
    'Rename' => 'Renombrar',
    'Show default swimlane' => 'Mostrar canal por defecto',
    'Swimlane modification for the project "%s"' => 'Modificación del canal para el proyecto "%s"',
    'Swimlane not found.' => 'Canal no encontrada',
    'Swimlane removed successfully.' => 'Canal eliminada correctamente',
    'Swimlanes' => 'Canales',
    'Swimlane updated successfully.' => 'Canales actualizados correctamente',
    'The default swimlane have been updated successfully.' => 'El canal por defecto ha sido actualizada correctamente',
    'Unable to create your swimlane.' => 'Imposible crear un canal',
    'Unable to remove this swimlane.' => 'Imposible de quitar este canal',
    'Unable to update this swimlane.' => 'Imposible de actualizar este canal',
    'Your swimlane have been created successfully.' => 'El canal ha sido creada correctamente',
    ...
    'Next' => 'Siguiente',
    '#%d' => '#%d',
    'All swimlanes' => 'Todos los canales',
    ...
    'Take a screenshot and press CTRL+V or ⌘+V to paste here.' => 'Capture un patallazo y pulse CTRL+V.',
    'Screenshot uploaded successfully.' => 'Pantallazo cargado con éxito',
    'SEK - Swedish Krona' => 'SEK - Corona sueca',
    'The project identifier is an optional alphanumeric code used to identify your project.' => 'El identificador del proyecto es un código opcional alfanumérico que se usa para identificar su proyecto.',
    'Identifier' => 'Identificador',
    'Disable two factor authentication' => 'Desactivar la autenticación de dos factores',
    'Do you really want to disable the two factor authentication for this user: "%s"?' => '¿Realmentes quiere desactviar la autenticación de dos factores para este usuario: "%s?"',
    ...
    'Swimlane change' => 'Cambio de canal',
    'Assignee change' => 'Cambio de concesionario',
    '[%s] Overdue tasks' => '[%s] Tareas vencidas',
    'Notification' => 'Notificación',
    '%s moved the task #%d to the first swimlane' => '%s movió la tarea #%d del primer canal',
    '%s moved the task #%d to the swimlane "%s"' => '%s movió la tarea #%d al canal "%s"',
    'Swimlane' => 'Canal',
    'Gravatar' => 'Gravatar',
    '%s moved the task %s to the first swimlane' => '%s movió la tarea %s al primer canal',
    '%s moved the task %s to the swimlane "%s"' => '%s movió la tarea %s al canal "%s"',
    'This report contains all subtasks information for the given date range.' => 'Este informe contiene toda la información de las subtareas para el rango proporcionado de fechas.',
    'This report contains all tasks information for the given date range.' => 'Este informe contiene toda la información de las tareas para el rango proporcionado de fechas.',
    'Project activities for %s' => 'Actividades del proyecto para %s',
    'view the board on Kanboard' => 'ver el tablero en Kanboard',
    'The task have been moved to the first swimlane' => 'Se ha movido la tarea al primer canal',
    'The task have been moved to another swimlane:' => 'Se ha movido la tarea a otro canal',
    ...
    'Do you really want to close the task "%s" as well as all subtasks?' => '¿Desea cerrar la tarea "%s" así como todas las subtareas?',
    'Swimlane: %s' => 'Canal: %s',
    ...
    'Current swimlane: %s' => 'Canales en curso: %s',
    ...
    'Change task color when using a specific task link' => 'Cambiar color de la tarea al usar un enlace específico a tarea',
    ...
    'Swimlane changed for task #%d' => 'Se cambió el canal de la tarea #%d',
    ...
    'Collapse swimlane' => 'Contraer canal',
    'Expand swimlane' => 'Ampliar canal',
    ...
    'There is no column or swimlane activated in your project!' => 'No hay ninguna columna o canal activo en el proyecto!',
    ...
    '%s attached a new file to the task %s' => '%s Adjunta un archivo nuevo a la tarea %s',
    'Assign automatically a category based on a link' => '',
    // 'BAM - Konvertible Mark' => '',
    'Assignee Username' => 'Asignar usuario',
    'Assignee Name' => 'Asignar nombre',
    'Groups' => 'Grupo',
    'Members of %s' => 'Miembro de',
    'New group' => 'Grupo nuevo',
    'Group created successfully.' => 'Grupo creado',
    'Unable to create your group.' => 'No se puede crear su grupo',
    'Edit group' => 'Editar grupo',
    'Group updated successfully.' => ' Grupo actualizado correctamente',
    'Unable to update your group.' => ' No se puede actualizar el grupo',
    'Add group member to "%s"' => 'Añadir miembro del grupo a "%s" ',
    'Group member added successfully.' => 'Miembro del grupo agregado',
    'Unable to add group member.' => 'No se puede agregar miembro',
    'Remove user from group "%s"' => 'eliminar usuario del gropo "%s"',
    'User removed successfully from this group.' => 'Usuario eliminado correctamanete del grupo',
    'Unable to remove this user from the group.' => 'No se puede eliminar usuario del grupo',
    'Remove group' => 'Eliminar grupo',
    'Group removed successfully.' => 'Grupo eliminado correctamente',
    'Unable to remove this group.' => 'No se puede eliminar este grupo',
    'Project Permissions' => 'Permisos de proyecto',
    // 'Manager' => '',
    'Project Manager' => 'Administrador de proyecto',
    'Project Member' => 'Miembros del proyecto',
    'Project Viewer' => 'Visor de proyectos',
    'Your account is locked for %d minutes' => 'Su cuenta esta bloqueada por %d minutos ',
    'Invalid captcha' => 'Código de imagen no válido',
    ...
    'Do you really want to remove the user "%s" from the group "%s"?' => '¿Desea eliminar al usuario "%s" del grupo "%s"?',
    'There is no group.' => 'No hay grupo',
    // 'External Id' => '',
    'Add group member' => 'Agregar miembro al grupo',
    'Do you really want to remove this group: "%s"?' => '¿Desea eliminar este grupo: "%s"?',
    'There is no user in this group.' => 'No hay usuarios en este grupo',
    'Remove this user' => 'Eliminar este usuario',
    'Permissions' => 'Permisos',
    'Allowed Users' => 'Usuarios autorizados',
    'No user have been allowed specifically.' => 'Ningun usuario h sido permitido',
    'Role' => 'Rol',
    'Enter user name...' => 'Ingresar nombre de usuario',
    'Allowed Groups' => 'Grupos autorizados',
    'No group have been allowed specifically.' => 'Ningun grupo ha sido permitido',
    'Group' => 'Grupo',
    'Group Name' => 'Nombre del grupo',
    'Enter group name...' => 'Ingresar nombre del grupo',
    'Role:' => 'Rol:',
    'Project members' => 'Miembros de proyecto',
    'Compare hours for "%s"' => 'Comparar horas por "%s"',
    '%s mentioned you in the task #%d' => '%s te han mencionado en la tarea #%d',
    '%s mentioned you in a comment on the task #%d' => '%s te han mencionado en un comentario en la tarea %s',
    'You were mentioned in the task #%d' => 'Se te ha mencionado en la tarea #%d',
    'You were mentioned in a comment on the task #%d' => 'Se te ha mencionado en un comentario en la tarea #%d',
    'Mentioned' => 'Mencionado',
    'Compare Estimated Time vs Actual Time' => 'Comparar Tiempo estimado vs Tiempo real',
    'Estimated hours: ' => 'Horas estimadas',
    'Actual hours: ' => 'Horas reales',
    'Hours Spent' => 'Horas dedicadas',
    'Hours Estimated' => 'Estimacion de horas',
    'Estimated Time' => 'Tiempo estimado',
    'Actual Time' => 'Tiempo real',
    'Estimated vs actual time' => 'Tiempo estimado vs real',
    // 'RUB - Russian Ruble' => '',
    'Assign the task to the person who does the action when the column is changed' => '',
    'Close a task in a specific column' => 'Cerrar una tarea en una columna especifica',
    ...
    'There is no integration registered at the moment.' => 'No hay integración registrada en el momento',
    'Password Reset for Kanboard' => 'Restablecer contraseña para la aplicacion',
    'Forgot password?' => 'Olvide mi contraseña',
    'Enable "Forget Password"' => 'Activar "Olvide contraseña"',
    'Password Reset' => 'Restablecer contraseña',
    'New password' => 'Nueva contraseña',
    'Change Password' => 'Cambiar contraseña',
    'To reset your password click on this link:' => 'Para restablecer tu contraseña click aqui',
    'Last Password Reset' => 'Último restablecimiento de contraseña',
    'The password has never been reinitialized.' => 'La contraseña nunca se ha reinicializado',
    'Creation' => 'Creacion',
    'Expiration' => 'Vencimiento',
    'Password reset history' => 'Historia de restablecimiento de contraseña',
    'All tasks of the column "%s" and the swimlane "%s" have been closed successfully.' => 'Todas las tareas de la columna "%s" y el canal "% s" se han cerrado con éxito',
    'Do you really want to close all tasks of this column?' => '¡Desea cerrar todas las tareas de esta columna?',
    '%d task(s) in the column "%s" and the swimlane "%s" will be closed.' => '%d tarea(s) in la columna "%s" y el canal "%s" seran cerrados',
    'Close all tasks of this column' => 'Cerra todas la tareas de esta columna',
    'No plugin has registered a project notification method. You can still configure individual notifications in your user profile.' => 'No se ha registrado plugin del método de notificación del proyecto. Puede configurar las notificaciones individuales en su perfil de usuario.',
